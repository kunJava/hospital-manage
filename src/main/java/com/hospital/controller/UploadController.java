...
public class UploadController {
    ...
    @ResponseBody
    public String uploadImage(@RequestParam MultipartFile fileRequest) throws Exception {
        try{
            File srcFile = new File(fileRequest.getOriginalFilename());
            //得到文件map对象
            String fileId = UploadUtils.uploadFile(fileRequest,null);
