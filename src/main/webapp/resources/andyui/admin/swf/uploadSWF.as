package 
{
	...
	public class uploadSWF extends MovieClip
	{
		...
		private var rootFileCounts = root.loaderInfo.parameters["filesCounts"];//上传文件类型字段
		...
		public function uploadSWF()
		{
			...
			/*ul.url = "http://172.16.117.237/cs/do.php";
			rootFiles = "true";
			rootFileNameData = "Filedata";
			upload_id = "uploadname";
			rootUpLoadUrl = "http://172.16.117.237/cs/do.php";*/
